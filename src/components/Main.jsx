...
const Main = () => {
  return (
    ...
    <main className="mx-auto mb-auto flex flex-1 flex-col items-center justify-center sm:max-w-full">
      <article className="px-8 pb-7 pt-8 sm:px-0">
        <h1>
        ...
        <p className="my-4 text-center leading-relaxed text-ffs-grayish-blue sm:max-w-[508px] sm:text-[1rem]">
          Our Arificial Intelligence powered tools use millions of project data
          point to ensure that your project is successful
        </p>
      </article>
      <section className="flex flex-col gap-6 px-8 py-8 sm:grid  sm:max-w-[1112px] sm:grid-cols-3 sm:items-center sm:gap-8 sm:px-0">
